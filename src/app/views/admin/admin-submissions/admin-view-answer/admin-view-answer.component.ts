...
@Component({
  selector: 'app-admin-view-answer',
  templateUrl: './admin-view-answer.component.html',
  styleUrls: ['./admin-view-answer.component.css']
})
export class AdminViewAnswerComponent implements OnInit {
