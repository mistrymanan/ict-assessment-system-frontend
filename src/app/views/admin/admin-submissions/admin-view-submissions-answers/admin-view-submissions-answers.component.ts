...
@Component({
  selector: 'app-admin-view-submissions-answers',
  templateUrl: './admin-view-submissions-answers.component.html',
  styleUrls: ['./admin-view-submissions-answers.component.css']
})
export class AdminViewSubmissionsAnswersComponent implements OnInit {
